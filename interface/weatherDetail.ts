...
export interface IGetWeatherDetailResponse extends IResponse {
    status: number | undefined;
    data?: IWeatherDetailResponse[];
}

export interface IWeatherDetailResponse {
...
export interface Metric29 {
    Value: number;
    Unit: string;
    UnitType: number;
}

export interface Imperial29 {
    Value: number;
    Unit: string;
    UnitType: number;
}
