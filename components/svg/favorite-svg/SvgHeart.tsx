...
function SvgHeart(props: Props) {
	return props.isFavorite ? (
		<svg
			xmlns='http://www.w3.org/2000/svg'
			viewBox='0 0 512 512'
			className={`${props.style} fill-[rgb(250,45,45)] hover:fill-[rgba(255,80,80)] cursor-pointer`}
		>
		...
		<svg
			xmlns='http://www.w3.org/2000/svg'
			viewBox='0 0 512 512'
			className={`${props.style} fill-[rgb(10,10,10)] hover:fill-[rgba(255,80,80)] dark:fill-[rgb(240,240,240)] dark:hover:fill-[rgba(255,80,80)] cursor-pointer`}
		>
